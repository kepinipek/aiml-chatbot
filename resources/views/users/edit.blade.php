...
@section('content')
    @include('layouts.navbar', ['title' => 'Mengedit User'])
                    ...
                    <div class="card-body">
                        <form action="{{ route('users.update', $user->slug) }}" method="POST">
                            ...
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="radio" name="is_admin" id="customRadio1" value="1" {{ $user->is_admin ? 'checked' : '' }}>
                                <label class="custom-control-label" for="customRadio1">Admin</label>
                              </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_admin" id="customRadio2" value="0" {{ $user->is_admin ? '' : 'checked' }}>
